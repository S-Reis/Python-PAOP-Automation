#This is the final completed version that can be succesfully run.
#Last modified: 8/27/2014 14:17


import os, shutil,os.path, datetime, xlrd, xlsxwriter, datetime, calendar,string


def FileReadandCreate(dirLocPAOP,FiletoRead,SheettoRead,Region1,Region2,Region3,Type1,Type2):
    ...
    # Create a workbook
    Cworkbook = xlsxwriter.Workbook(FiletoRead)
...
FileReadandCreate("C:\Users\sjolly\Desktop\TestFolder 2\Dufferin-Peel\Year13-14\Individual Months",'TestLocationPAOP1.xlsx', 'Sheet1', "Y - Area East", "Y - Area North", "Y - Area West", "Y - Type High School","Y - Type Elementary/Middle")
